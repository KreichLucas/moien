...
export function makeDashboardStyles() {
  return StyleSheet.create({
    ...
    sidebarProgressHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 },
    sidebarProgressLevel: { fontFamily: fontFamilies.displayBold, fontSize: 13, color: authColors.textPrimary },
    sidebarProgressPct: { fontFamily: fontFamilies.displaySemiBold, fontSize: 12, color: authColors.accentCyan },
    sidebarProgressBarTrack: {
      height: 6,
      borderRadius: 3,
      backgroundColor: authColors.inputBg,
      overflow: 'hidden',
    },
    sidebarProgressBarFill: { height: '100%', borderRadius: 3, backgroundColor: authColors.accentCyan },
    sidebarProgressCaption: { fontFamily: fontFamilies.displayRegular, fontSize: 11, color: authColors.textSecondary, marginTop: 8 },
    sidebarStatsRow: { flexDirection: 'row', gap: 8, marginTop: 12 },
    sidebarStatChip: {
      flex: 1,
      flexDirection: 'row',
      alignItems: 'center',
    ...
    sidebarStatChipText: { fontFamily: fontFamilies.displaySemiBold, fontSize: 12, color: authColors.textPrimary },
    sidebarBottom: {},
    sidebarQuoteCard: {
      backgroundColor: authColors.cardBg,
      borderWidth: 1,
